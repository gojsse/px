...
const SpriteEditorActionbar = ({ spriteIndex }) => {
  ...
  return (
    <div className={styles.spriteEditorActionbar + " w-full mb-2"}>
      ...
      <button
        {...buttonAttributes}
        onClick={() => handleClick(shiftSpriteRight)}
      >
      ...
      <button
        {...buttonAttributes}
        onClick={() => handleClick(shiftSpriteDown)}
      >
        <ArrowSmDownIcon className={iconClasses} />
      </button>
      <button
        {...buttonAttributes}
        onClick={() => handleClick(flipSpriteHorizontal)}
      >
        <SwitchHorizontalIcon className={iconClasses} />
      </button>
      <button
        {...buttonAttributes}
        onClick={() => handleClick(flipSpriteVertical)}
      >
        <SwitchVerticalIcon className={iconClasses} />
      </button>
      <button
        {...buttonAttributes}
        onClick={() => handleClick(rotateSpriteLeft)}
      >
        <ReplyIcon className={iconClasses} />
      </button>
      <button
        {...buttonAttributes}
        onClick={() => handleClick(rotateSpriteRight)}
      >
        <ReplyIcon
